...
import eventData from '../../utils/events_personal';
...
export default class PersonalView extends Component {
  ...
  onCardOpenChange(item, isOpen) {
    ...
    Navigation.mergeOptions(this.props.componentId, { bottomTabs: {visible: isOpen ? false : true, animate: true} });
    // Remove Safe area
  ...
  render() {
    ...
    return (
      <View style={styles.flex} testID="PERSONAL_HOST_VIEW">
